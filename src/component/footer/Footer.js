          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <span className="text-success">Street:</span> 16/a, bangabandhu avenue, 2nd floor, 1000, <br /> Dhaka <br />
                <span className="text-success">Zip code:</span> 1000
                </address>
                <a
                  href="tel:+02 9115411"
                  className="mt-2 d-block mb-1 text-white"
                >
                <BsFillTelephoneFill/>  +02 9115411
                </a>
                <a
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center text-white mb-0">
                &copy;{new Date().getFullYear()}: Powered by Shahriar Reza. All rights reserved.
              </p>
            </div>
          </div>
        </div>
